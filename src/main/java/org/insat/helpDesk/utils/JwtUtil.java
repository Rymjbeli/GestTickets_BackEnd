...
public class JwtUtil {
    ...
    private static final long REMEMBER_ME_EXPIRATION_TIME = 60L * 60L * 24L * 30L * 1000L; // 30 days in milliseconds
    private static final long DEFAULT_EXPIRATION_TIME = 60 * 60 * 24 * 1000; // 1 day in milliseconds
    ...
    public String generateToken(String userName, boolean rememberMe) {
        ...
        Date expiration;
        if (rememberMe) {
            expiration = new Date(System.currentTimeMillis() + REMEMBER_ME_EXPIRATION_TIME);
        } else {
